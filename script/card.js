...
var UNKNOWN = "Unknown"
var MASTERCARD_CARD_TYPE = {name: "Mastercard", lengths: [16],
  ranges:[{minStart:"2221", maxStart:"2720"}, {minStart:"51", maxStart:"55"}], isValid: true}
var AMERICAN_EXPRESS_CARD_TYPE = {name: "American Express", lengths: [15],
  ranges:[{minStart:"34", maxStart:"34"}, {minStart:"37", maxStart:"37"}], isValid: true}
var VISA_CARD_TYPE = {name: "Visa", lengths: [13, 16, 19],
  ranges: [{minStart:"4", maxStart:"4"}], isValid: true}

var VALID_CARD_TYPES = [MASTERCARD_CARD_TYPE, AMERICAN_EXPRESS_CARD_TYPE, VISA_CARD_TYPE]
var INVALID_CARD_TYPE = {name: UNKNOWN, isValid: false}
...
function validateCard(cardNumber) {
  var validatedType = INVALID_CARD_TYPE
    ...
    return {cardType: validatedType.name, isValid: validatedType.isValid}
}
